...
function draw() {
	...
	//(não é esse)image(paperImg,ball.position.y,ball.position.x,radius,radius); nao e esse
	//(não é esse)image(paperImg,ball.position.x,ball.position.y,radius/2,radius/2);
	//(não é esse) ellipse(ball.position.x,ball.position.y,radius,radius);
